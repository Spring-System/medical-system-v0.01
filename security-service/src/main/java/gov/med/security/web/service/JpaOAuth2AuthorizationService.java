...
import gov.med.security.web.repository.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, JpaRegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(Collection.class, Users.class);
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        if (tokenType == null) {
            result = this.authorizationRepository.findByAuthorizationCodeValueOrAccessTokenValueOrRefreshTokenValue(token);
